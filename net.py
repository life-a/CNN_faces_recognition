"""-----------------------------------------
net定义了神经网络结构 - TensorFlow 2.x兼容版本
-----------------------------------------"""
...
def layer_net(input_image, num_class, dropout_rate, dropout_rate_2):
    ...
    layer_pool1 = tf.nn.max_pool2d(layer_conv1, ksize=[1, 2, 2, 1], strides=[1, 2, 2, 1], padding='SAME')  # 32*32*32，池化降维，减小复杂度
    ...
    layer_pool3 = tf.nn.max_pool2d(layer_conv3, ksize=[1, 2, 2, 1], strides=[1, 2, 2, 1], padding='SAME')       # 8*8*64=4096
