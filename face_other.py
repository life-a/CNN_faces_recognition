...
source_path = './img_source/Asian_faces_160'
faces_stranger_path = 'face_asian'
size = 64
if not os.path.exists(faces_stranger_path):
    os.makedirs(faces_stranger_path)
    ...
    for filename in filenames:
        if filename.endswith('.jpg'):
            ...
            for i, d in enumerate(dets):
                ...
                cv2.imwrite(faces_stranger_path+'/'+str(num)+'.jpg', face)   #保存
                num += 1
